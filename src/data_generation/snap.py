...
def run_snap_pipeline(customers_path="data/customers.csv", behavior_path="data/credit_behavior_monthly.csv", output_path="data/model_snapshots.csv"):
    # =============================
    # LOAD DATA
    # =============================
    print(f"Loading data from {customers_path} and {behavior_path}...")
    try:
    ...
    # SAVE
    # =============================
    if safe_save_csv(snapshots_df, output_path):
